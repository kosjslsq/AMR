...
try:
        ...
        cetak(nel('\t• ☠️ آهہلآ بٰٰكہٰ فہٰيٰ اداة الہٰمطہٰور نادر'))
...
print(B+'_'*40)
print(F+'➨ '+Y+'BY '+E+'@nader20090'+B+'| NADER'+Z)
print(B+'_'*40)
print('\n')
...
def login_lagi334():
	try:
		...
		your_cookies = input(f'[{h}*{x}] Masukkan Cookiesضع كہوٌكہيہز مہجہددآ :{asu} ')
...
def menu(my_name,my_id):
	...
	print(Z+'\x1b[38;5;208mTelegram ⌲ @nader20090  ')
	print(F+          'VIP')
	print('[v-1]')
	print(f'»  Your IDايديك ⌲ : '+str(my_id))
	print(f'»  Your IPايبي جهازك ⌲: {ip}')
	print('')
...
def follower():
	...
	for userr in uid:
		try:
			...
			print('[✘] Id Is Not Public&ايدياتك خطا')
			time.sleep(3)
			follower()
